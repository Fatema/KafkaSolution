...
sleep 10 && ${CONFLUENT_HOME}/bin/kafka-server-stop configs/kafka-server-01.properties &
sleep 10 && ${CONFLUENT_HOME}/bin/kafka-server-stop configs/kafka-server-02.properties &
sleep 10 && ${CONFLUENT_HOME}/bin/kafka-server-stop configs/kafka-server-03.properties &
sleep 10 && ${CONFLUENT_HOME}/bin/kafka-server-stop configs/kafka-server-04.properties &
